...
load example_data
lab = lab(1:124, :);% for testing purposes only
...
figure, boxplot(enorm,lab,'labels',net,'labelorientation','inline'); title('Norm entropy per system (fake network assignments)')
